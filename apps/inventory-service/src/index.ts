...
import { PostgresInventoryItemRepository } from "./infrastructure/repositories/PostgresInventoryItemRepository.js";
import { createHealthRouter } from "./interface/http/routes/health.js";
import { createInventoryRouter } from "./interface/http/routes/inventory.js";
...
async function main(): Promise<void> {
  ...
  const repository = new PostgresInventoryItemRepository(pool);
  const app = express();
  ...
  app.use(createInventoryRouter(repository));
