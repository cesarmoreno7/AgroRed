...
import { PostgresProducerRepository } from "./infrastructure/repositories/PostgresProducerRepository.js";
import { createHealthRouter } from "./interface/http/routes/health.js";
import { createProducersRouter } from "./interface/http/routes/producers.js";
...
async function main(): Promise<void> {
  ...
  const repository = new PostgresProducerRepository(pool);
  const app = express();
  ...
  app.use(createProducersRouter(repository));
