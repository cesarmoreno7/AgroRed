...
import { PostgresDemandRepository } from "./infrastructure/repositories/PostgresDemandRepository.js";
import { createHealthRouter } from "./interface/http/routes/health.js";
import { createDemandsRouter } from "./interface/http/routes/demands.js";
...
async function main(): Promise<void> {
  ...
  const repository = new PostgresDemandRepository(pool);
  const app = express();
  ...
  app.use(createDemandsRouter(repository));
