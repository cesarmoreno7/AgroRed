...
import { PostgresInstitutionRepository } from "./infrastructure/repositories/PostgresInstitutionRepository.js";
import { createHealthRouter } from "./interface/http/routes/health.js";
import { createInstitutionsRouter } from "./interface/http/routes/institutions.js";
...
async function main(): Promise<void> {
  ...
  const repository = new PostgresInstitutionRepository(pool);
  const app = express();
  ...
  app.use(createInstitutionsRouter(repository));
